  ...
  <div class="container">
    <div id="resume-header" class="row">
      ...
      <div class="col">
        ...
        <h2>PHP Developer</h2>
        <ul>
          <li>Mail: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8fe7eaecfbe0fdcfe2eee6e3a1ece0e2">[email&#160;protected]</a></li>
          <li>Phone: 48181025</li>
          <li>LinkedIn: https://linkedin.com</li>
          <li>Twitter: @josuechaqui</li>
        </ul>
      </div>
    </div>
    <div class="row">
